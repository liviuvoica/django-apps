...
from newsletter_api.permissions import IsOwnerOrReadOnly
...
class NewsletterList(generics.ListCreateAPIView):
    ...
    serializer_class = serializers.NewsletterListSerializer
...
class NewsletterListDetail(generics.RetrieveUpdateDestroyAPIView):
    queryset = NewsletterList.objects.all()
    serializer_class = serializers.NewsletterListSerializer
